# Course 8 Final Lab
# Analyze the performance of the roporting airline to improve flight reliability
                                    ...
                                    html.Div([
                                        ...
                                        # TODO2: Add a dropdown
                                          dcc.Dropdown(id='input-type', 
                                                ...
                                                style={'width':'80%','padding':'3px','font-size':'20px','text-align-last':'center'})# this may be wrong
